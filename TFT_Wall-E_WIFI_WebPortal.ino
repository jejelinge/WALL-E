...
#define CALIBRATION_FILE "/calibrationData12"  // This is the file name used to store the touch coordinate - Change the name to start a new calibration.
...
WiFiManager manager;    
  ...
  res = manager.autoConnect("WALL-E","password");
  if(!res) {
 ...
 delay(3000);
  ...
  if (!myDFPlayer.begin(FPSerial, /*isACK = */ true, /*doReset = */ true)) {  //Use serial to communicate with mp3.
    ...
    tft.drawString("4. Reboot the ESP32", 10, 140, 4);
    while (true) {
      delay(0);
    }
  }
